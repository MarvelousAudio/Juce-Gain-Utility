...
//==============================================================================
const String PracticeAudioProcessor::getName() const
{
...
const String PracticeAudioProcessor::getProgramName (int index)
{
    return {};
}

void PracticeAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
#endif
//=========================================================================================================
//definition of what the plugin runs on
//PROCESSOR BLOCK!
void PracticeAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
//==============================================================================
//when developing shoud return false to get audio working first!
bool PracticeAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

AudioProcessorEditor* PracticeAudioProcessor::createEditor()
{
    return new PracticeAudioProcessorEditor (*this);
}

//==============================================================================
void PracticeAudioProcessor::getStateInformation (MemoryBlock& destData)
{
